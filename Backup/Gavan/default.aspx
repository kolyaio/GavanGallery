<%@ Page Title="" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Gavan.mydefault" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			<div class="order">
				<ul>
                    ...
                    <li>
			            <dl>
				            <dt><a href="default.aspx">הכי חדש</a></dt>
				            <dt><a href="default.aspx?sort=oldest">הכי ישן</a></dt>
				            <dt><a href="#mostrank">הכי מדורגים</a></dt>
				            <dt><a href="#mostpop">הכי פופולאריים</a></dt>
				            <dt><a href="default.aspx?sort=byalphaup">לפי הא'-ב' סדר עולה</a></dt>
				            <dt><a href="default.aspx?sort=byalphadown">לפי הא'-ב' סדר יורד</a></dt>
			            </dl>
                    </li>
				</ul>
			</div>
