<%@ Page Title="" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Gavan.register" %>
...
<div id="register_form">
	<h1>טופס הרשמה</h1>
		<form autocomplete="off" id="Form1" action="register.aspx" method="post" onsubmit="return checkForm()" runat="server">
			<ul>
				<li class="name">
				...
				<li class="studstaff">
					...
					<input type="radio" name="studstaff"  value="1" checked="checked" onclick="document.getElementById('gradeli').style.display='inline'" />
					<label for="student">תלמיד</label>
					<input type="radio" name="studstaff" value="2" onclick="document.getElementById('gradeli').style.display='none'"/>
