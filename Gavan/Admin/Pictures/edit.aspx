<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Gavan.Admin.Pictures.edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    %>
		<form action="editPictureAct.aspx" id="formEdit" method="post">
			<dl>
