<%@ Page Title="Gavan - עריכת דפים" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"  ValidateRequest="false" CodeBehind="edit.aspx.cs" Inherits="Gavan.Admin.pages.edit" %>
        ...
        <form action="edit_act.aspx" method="post">
            <dl>
                <dt><label>שם התוכן:</label><input type="text" id="name" name="name" value="<%=this.getDetails(id)[0]%>"/></dt>
                 <dt><label>כתובת:</label><input type="text" id="url" name="url" value="<%=this.getDetails(id)[2]%>"/></dt>
